...
export const charData = {
  ...
  "choiyuhyun": {
    ...
    skills: [
      ...
      { id: "choiyuhyun_skill5", excludeFromBuffSearch: true, decimalPlaces: 2, name: "신화성신환", icon: "icon/passive5.webp", desc: "방어 시 2턴 간 유현의 공격에 {0}%의 추가데미지가 발생", calc: [{ max: 100 }], damageDeal: [{ type: "추가공격", val: { max: 100 } }] },
  ...
  "duncan": {
    ...
    skills: [
       { 
        ...
        damageDeal: [{ type: "보통공격", val: { max: 120,startRate:0.64 } }]
      },
      {
        id: "duncan_skill2",
        excludeFromBuffSearch: false,
        ...
        damageDeal: [{ type: "필살공격", val: { max: 120,startRate:0.64 } }]
      },
      {
        id: "duncan_skill3",
        excludeFromBuffSearch: false,
  ...
  "rikano": {
    ...
    skills: [
      { 
        ...
        name: "분위기 띄우기!", 
        icon: "icon/attack.webp", 
        desc: "목표물에게 [받는 데미지가 {0}% 증가](2턴)를 부여한 후 ATK {1}%의 데미지를 줌", 
        ...
        toggleType: "isApplied",                      
              name: "스타 강아지☆출첵", 
              icon: "icon/attack(strong).webp", 
              desc: "(쿨타임 : 3턴) \n 목표물에게 [받는 데미지가 {0}% 증가](2턴)를 부여한 후 ATK {1}%의 데미지를 줌", 
              stampDesc: "(쿨타임 : 3턴) \n 목표물에게 [조롱](1턴)효과와 [받는 데미지가 {0}% 증가](2턴)를 부여한 후 ATK {1}%의 데미지를 줌",
      ...
      },
      {
        ...
        name: "사이드라인 아이돌",
        icon: "icon/passive2.webp",
        desc: "아군 전체 필살기 효과 {0}% 증가, 필살기 발동 시 목표물에게 [받는 데미지가 {1}% 증가](1턴) 부여",
      ...
      { id: "rikano_skill5", 
        ...
        name: "마음을 사로잡는 매력", 
        icon: "icon/passive5.webp", 
        desc: "필살기 발동 시 [적군 랜덤 목표물에게 ATK {0}%로 공격]을 2회 발동, 해당 효과는 필살기 데미지로 간주", 
        calc: [{ max: 50 }],
      ...
      },
      {
        ...
        name: "빛나는 스타", 
        icon: "icon/passive5.webp", 
        desc: "자신을 제외한 아군 전체의 목표물이 [조롱] 효과를 보유할 경우, 자신 주는 데미지가 {0}% 증가 발동", 
        calc: [{ max: 18 }] 
      },
            { id: "rikano_skill8",
        name: "사이드라인 아이돌[디버프]", 
